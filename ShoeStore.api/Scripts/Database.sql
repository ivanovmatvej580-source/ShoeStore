...
INSERT OR IGNORE INTO customers (first_name, last_name, phone, email) 
VALUES ('Admin', 'System', 'admin', 'admin@shop.com');

-- Товары
INSERT OR IGNORE INTO products (name, brand, category, price, discount_price, color, stock_quantity) 
VALUES 
...
INSERT OR IGNORE INTO customers (first_name, last_name, phone, email, birth_date, gender, shoe_size) 
VALUES 
...
-- Тестовые заказы
INSERT OR IGNORE INTO orders (customer_id, order_date, status, total_amount) 
VALUES 
...
INSERT OR IGNORE INTO order_items (order_id, product_id, quantity, price_at_time, size) 
VALUES 
    (1, 1, 1, 8099, '42'),
    (1, 2, 1, 7499, '41'),
    (2, 4, 1, 4499, '38'),
